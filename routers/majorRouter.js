...
router.get(
  "/getCategoriesByMajorCode/:major_code",
  majorController.getCategoriesByMajorCode
);
router.get(
  "/getGroupsByCategoryId/:category_id",
  majorController.getGroupsByCategoryId
);
router.get(
  "/getCoursesByGroupId/:group_id",
  majorController.getCoursesByGroupId
);
router.get(
  "/getCoursesByCategoryId/:category_id",
  majorController.getCoursesByCategoryId
);
